(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "@babel/runtime/helpers/extends", "@babel/runtime/regenerator", "@babel/runtime/helpers/asyncToGenerator", "@babel/runtime/helpers/classCallCheck", "@babel/runtime/helpers/createClass", "@babel/runtime/helpers/possibleConstructorReturn", "@babel/runtime/helpers/getPrototypeOf", "@babel/runtime/helpers/inherits", "@babel/runtime/helpers/defineProperty", "@babel/runtime/helpers/objectSpread", "react", "react-intl", "hoist-non-react-statics", "invariant", "./injectIntl", "./getDisplayName", "./intlHelper", "umi/locale", "./toClass", "./compose", "./parseArguments/", "./fetchIntl/locale", "./fetchIntl/remote"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("@babel/runtime/helpers/extends"), require("@babel/runtime/regenerator"), require("@babel/runtime/helpers/asyncToGenerator"), require("@babel/runtime/helpers/classCallCheck"), require("@babel/runtime/helpers/createClass"), require("@babel/runtime/helpers/possibleConstructorReturn"), require("@babel/runtime/helpers/getPrototypeOf"), require("@babel/runtime/helpers/inherits"), require("@babel/runtime/helpers/defineProperty"), require("@babel/runtime/helpers/objectSpread"), require("react"), require("react-intl"), require("hoist-non-react-statics"), require("invariant"), require("./injectIntl"), require("./getDisplayName"), require("./intlHelper"), require("umi/locale"), require("./toClass"), require("./compose"), require("./parseArguments/"), require("./fetchIntl/locale"), require("./fetchIntl/remote"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global._extends, global.regenerator, global.asyncToGenerator, global.classCallCheck, global.createClass, global.possibleConstructorReturn, global.getPrototypeOf, global.inherits, global.defineProperty, global.objectSpread, global.react, global.reactIntl, global.hoistNonReactStatics, global.invariant, global.injectIntl, global.getDisplayName, global.intlHelper, global.locale, global.toClass, global.compose, global.parseArguments, global.locale, global.remote);
    global.index = mod.exports;
  }
})(this, function (_exports, _extends2, _regenerator, _asyncToGenerator2, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _defineProperty2, _objectSpread2, _react, _reactIntl, _hoistNonReactStatics, _invariant, _injectIntl, _getDisplayName, _intlHelper, _locale, _toClass, _compose, _parseArguments, _locale2, _remote) {
  "use strict";
  ...
  _locale2 = _interopRequireDefault(_locale2);
                  ...
                  switch (_context2.prev = _context2.next) {
                        ...
                        return _regenerator.default.wrap(function _callee$(_context) {
                          while (1) {
                            switch (_context.prev = _context.next) {
                              ...
                              case 5:
                                _context.next = 7;
                                return (0, _locale2.default)(locale, page);
                    ...
                    case 2:
                      ...
                      if (!localeData) {
                        ...
                        (0, _locale._setIntlObject)((0, _intlHelper.getIntlContext)());
                        this.setState({
                          translations: translations
                        });
                      }

...
const localeInfo = {
  'en-US': {
    messages: {
      ...require('/Users/jedi/workshop/an-github/umi-lib-paik/packages/umi-plugin-locale-paik/examples/base/src/locales/en-US.json'),
    },
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: {
      ...require('/Users/jedi/workshop/an-github/umi-lib-paik/packages/umi-plugin-locale-paik/examples/base/src/locales/zh-CN.json'),
    },
    locale: 'zh-CN',
  ...
  'zh-HK': {
    messages: {
      ...require('/Users/jedi/workshop/an-github/umi-lib-paik/packages/umi-plugin-locale-paik/examples/base/src/locales/zh-HK.json'),
    },
    locale: 'zh-HK',
    antd: require('antd/lib/locale-provider/zh_CN'),
    data: require('react-intl/locale-data/zh'),
  ...
  'zh-TW': {
    messages: {
      ...require('/Users/jedi/workshop/an-github/umi-lib-paik/packages/umi-plugin-locale-paik/examples/base/src/locales/zh-TW.json'),
    },
    locale: 'zh-TW',

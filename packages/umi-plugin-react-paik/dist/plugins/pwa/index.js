(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "path", "assert", "chalk", "workbox-webpack-plugin", "./WebManifestPlugin", "./generateWebManifest"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("path"), require("assert"), require("chalk"), require("workbox-webpack-plugin"), require("./WebManifestPlugin"), require("./generateWebManifest"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.path, global.assert, global.chalk, global.workboxWebpackPlugin, global.WebManifestPlugin, global.generateWebManifest);
    global.index = mod.exports;
  }
})(this, function (_exports, _path, _assert, _chalk, _workboxWebpackPlugin, _WebManifestPlugin, _generateWebManifest2) {
  "use strict";

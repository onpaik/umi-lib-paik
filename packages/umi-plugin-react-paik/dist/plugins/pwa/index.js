(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "@babel/runtime/helpers/objectSpread", "path", "assert", "chalk", "workbox-webpack-plugin", "./WebManifestPlugin", "./generateWebManifest"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("@babel/runtime/helpers/objectSpread"), require("path"), require("assert"), require("chalk"), require("workbox-webpack-plugin"), require("./WebManifestPlugin"), require("./generateWebManifest"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.objectSpread, global.path, global.assert, global.chalk, global.workboxWebpackPlugin, global.WebManifestPlugin, global.generateWebManifest);
    global.index = mod.exports;
  }
})(this, function (_exports, _objectSpread2, _path, _assert, _chalk, _workboxWebpackPlugin, _WebManifestPlugin, _generateWebManifest2) {
  "use strict";
